  ...
  return (
    ...
    >
      ...
      >
        <i
          className={`ti ${icon}`}
          style={{ color: c.iconFg, fontSize: "1.2rem" }}
          aria-hidden="true"
        />
      </div>
      ...
      >
        ...
        >
          <i
            className={`ti ${trendDir === "up" ? "ti-trending-up" : "ti-trending-down"}`}
            aria-hidden="true"
          />
          {trend}
        </span>
        <span style={{ fontSize: "0.72rem", color: "var(--kha-text3)" }}>
          {sub}
        </span>
      </div>
    </div>
  ...
  return (
    ...
    >
      ...
      >
        <i
          className={`ti ${icon}`}
          style={{ color: iconFg, fontSize: "0.9rem" }}
          aria-hidden="true"
        />
      </div>
      ...
      {tabs.map((t) => (
        <div
          ...
          style={{
            ...
            background:
              active === t.value ? "var(--kha-surface)" : "transparent",
            boxShadow:
              active === t.value ? "0 1px 3px rgba(0,0,0,.08)" : "none",
          }}
        >
          {t.label}
        </div>
...
const BAR_MEMBERS = [
  120, 190, 300, 280, 189, 239, 320, 280, 350, 310, 290, 270,
];
const BAR_FINANCES = [8, 9, 10, 11, 9, 12, 14, 13, 15, 14, 13, 12];
const LINE_ACTIVE = [
  800, 850, 900, 920, 950, 1000, 1050, 1080, 1120, 1150, 1180, 1200,
];
const LINE_TOTAL = [
  1000, 1100, 1200, 1250, 1300, 1350, 1400, 1450, 1500, 1550, 1600, 1650,
];
...
const ACTIVITIES = [
  {
    ...
    sub: "Sarah Kim registered as Active Member",
    time: "2m ago",
  },
  {
    icon: "ti-file-upload",
    ...
    sub: "2026 Annual Report.pdf added to library",
    time: "18m ago",
  },
  {
    icon: "ti-player-play",
    ...
    sub: "Intro to KHA Systems — 14 min",
    time: "1h ago",
  },
  {
    ...
    sub: "General Assembly reminder posted",
    time: "3h ago",
  },
];
      ...
      >
        <div style={{ maxWidth: 1280, margin: "0 auto" }}>
          ...
          <div className="kha-charts-grid kha-anim kha-anim-5">
            {/* Donut */}
            <ChartCard
              title={t("dashboard.memberDistribution")}
              sub={t("dashboard.activeVsAlumniBreakdown")}
            >
              <div
                style={{
                  position: "relative",
              ...
              >
                <canvas
                  ref={donutRef}
                  role="img"
                  aria-label="Donut chart: 850 active members, 384 alumni"
                >
                  850 active, 384 alumni.
                </canvas>
                <div
                  style={{
                    position: "absolute",
            ...
            <ChartCard
              ...
              action={
                <TabBar
                  tabs={[
                    { label: t("dashboard.both"), value: "both" },
                    { label: t("dashboard.members"), value: "members" },
                    { label: t("dashboard.finances"), value: "finances" },
                  ]}
                  active={barMode}
                  onSelect={setBarMode}
                />
            ...
            >
              ...
              <div style={{ position: "relative", height: 220 }}>
                <canvas
                  ref={barRef}
                  role="img"
                  aria-label="Bar chart of monthly members and finances"
                >
                  Monthly growth data.
                </canvas>
              </div>
          ...
          >
            <ChartCard
              ...
              action={
                <TabBar
                  tabs={[
                    { label: t("dashboard.12month"), value: 12 },
                    { label: t("dashboard.6month"), value: 6 },
                    { label: t("dashboard.3month"), value: 3 },
                  ]}
                  active={areaRange}
            ...
            >
                ...
                {[
                  ...
                  <span
                    ...
                    style={{
                      ...
                      color: "var(--kha-text2)",
                      cursor: "pointer",
                      opacity: legendActive[l.key] ? 1 : 0.4,
              ...
              <div style={{ position: "relative", height: 220 }}>
                <canvas
                  ref={areaRef}
                  role="img"
                  aria-label="Area chart of active and total members over 12 months"
                >
                  Member trend data.
                </canvas>
              </div>
          ...
          <div className="kha-charts-grid kha-anim kha-anim-6">
            ...
            <ChartCard
              ...
              sub={t("dashboard.2026AnnualTargets")}
            >
              <div
