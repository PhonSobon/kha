  ...
  return (
    <div ref={menuRef} className="relative">
      ...
      <NavbarContent className="hidden sm:flex gap-4 md:gap-6 lg:gap-8" justify="center">
        ...
        <NavbarItem>
          <Link href="/education" className="text-white text-sm md:text-base hover:text-blue-200 transition-colors">
            {t('navigation.education')}
          </Link>
        </NavbarItem>
        <NavbarItem>
          <Link href="/contact" className="text-white text-sm md:text-base hover:text-blue-200 transition-colors">
                ...
                <div className="relative flex items-center bg-amber-500 rounded-full px-1 py-1 w-16 sm:w-18 md:w-20 h-7 sm:h-8 md:h-9">
                  <div
                    className={`absolute top-0.5 sm:top-1 left-0.5 sm:left-1 transition-all duration-300 w-5 h-5 sm:w-6 sm:h-6 md:w-7 md:h-7 rounded-full bg-white shadow ${
                      i18n.language === "kh" ? "translate-x-6 sm:translate-x-7 md:translate-x-9" : "translate-x-0"
                    }`}
                    style={{ zIndex: 1 }}
                  />
                  <button
                      ...
                      <div className="relative flex items-center bg-amber-500 rounded-full px-1 py-1 w-20 h-9">
                        <div
                          className={`absolute top-1 left-1 transition-all duration-300 w-7 h-7 rounded-full bg-white shadow ${
                            i18n.language === "kh" ? "translate-x-9" : "translate-x-0"
                          }`}
                          style={{ zIndex: 1 }}
                        />
                        <button
