  ...
  en: {
    common: {
      ...
      "auth": {
        ...
        "forgotPasswordHero": "We’ll email you a secure link to reset your password.",
        "enterOtp": "Enter the 6-digit code",
        "otpSentToEmail": "We sent a 6-digit code to your email.",
        "otpLabel": "Verification code",
        "verifyCode": "Verify code",
        "otpRequired": "Code is required",
        "otpInvalid": "Please enter the 6-digit code",
        "newPasswordStepTitle": "Create a new password",
        "newPasswordStepSubtitle": "Use at least 6 characters to keep your account safe.",
  ...
  kh: {
    common: {
      ...
      "auth": {
        ...
        "enterOtp": "បញ្ចូលលេខកូដផ្ទៀងផ្ទាត់",
        "otpSentToEmail": "យើងបានផ្ញើកូដ ៦ ខ្ទង់ ទៅកាន់អ៊ីមែលរបស់អ្នក។",
        "otpLabel": "លេខកូដផ្ទៀងផ្ទាត់",
        "verifyCode": "ផ្ទៀងផ្ទាត់កូដ",
        "otpRequired": "ត្រូវការកូដ OTP",
        "otpInvalid": "សូមបញ្ចូលកូដ ៦ ខ្ទង់",
        "newPasswordStepTitle": "កំណត់ពាក្យសម្ងាត់ថ្មី",
        "newPasswordStepSubtitle": "បង្កើតពាក្យសម្ងាត់ដែលមានសុវត្ថិភាពសម្រាប់គណនីរបស់អ្នក។",
